...
contract TALETE is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    event LogRebase(uint256 indexed epoch, uint256 totalSupply);

    string public _name = "TALETE";
    string public _symbol = "TALETE";
    ...
    uint256 public RiskFreeValue = 6;
    uint256 public sellFee = 2;
    uint256 public burnFee = 3;
    uint256 public totalFee =
        liquidityFee.add(Treasury).add(RiskFreeValue).add(burnFee);
    ...
    constructor() ERC20Detailed("TALETE", "TALETE", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0xdfC2C8DC749cE510DCD3E872bAE43Db4E6C04a24;
        TreasuryReceiver = 0x020E6F09eB6a301d9d887c2002cB73A5Ba551CB1;
        RiskFreeValueReceiver = 0x2BCc65ea53d5f8c2df19dEEfF589fc868CD9794F;
        burnAddress = 0x848Fba4fC713A70F91aee2CFdFCa2a7e1A150414;
